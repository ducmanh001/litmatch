...
- Yêu cầu agent **tự chấm lại code theo đúng § 10.0, 10.1 và mục domain ở 10.2** sau khi viết xong 1 module/business flow nhạy cảm, trước khi báo "xong". Agent phải chỉ rõ các giả định về hành vi user và mỗi giả định được chặn ở đâu trong code.
