...
export const FriendErrors = {
  /** Không có conversation với profile (gộp not-found + chưa mở chat, chống oracle). */
...
export const ProfileSocialErrors = {
  PROFILE_NOT_AVAILABLE: 'PROFILE_SOCIAL_PROFILE_NOT_AVAILABLE',
  SELF_PROFILE_ACTION: 'PROFILE_SOCIAL_SELF_ACTION',
  MESSAGE_GIFT_REQUIRED: 'PROFILE_SOCIAL_MESSAGE_GIFT_REQUIRED',
} as const;
