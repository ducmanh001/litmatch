 ...
 * Friendship cho 1 cặp ⇒ tồn tại Conversation cho đúng cặp đó; profile direct chat cũng có thể
 * tạo Conversation trước Friendship (docs/services/friend-service.md § 1).
 */
