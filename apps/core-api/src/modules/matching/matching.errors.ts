...
export const MatchingErrors = {
  ...
  GUEST_DEVICE_TOKEN_REQUIRED: 'MATCHING_GUEST_DEVICE_TOKEN_REQUIRED',
  GUEST_DAILY_QUOTA_EXCEEDED: 'MATCHING_GUEST_DAILY_QUOTA_EXCEEDED',
  DAILY_QUOTA_EXCEEDED: 'MATCHING_DAILY_QUOTA_EXCEEDED',
