...
- Gateway hiện chỉ fanout realtime; quyền và lệnh điều khiển LiveKit thuộc port trong `core-api`.
  Mọi lệnh media ở component sở hữu nó phải đợi ACK trước khi commit trạng thái hoàn tất.
