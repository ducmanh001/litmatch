...
function buildReport(registry) {
  ...
  const lines = [
    ...
    '',
    'The registry is structured JSON and the generator performs local path/marker checks instead of trusting a manually copied status list. Validation is offline: the Arazzo 1.1 schema is vendored from the OpenAPI Initiative and AsyncAPI uses its official parser; no hosted validation service is called.',
    '',
    '## 2. Consolidation and canonical ownership',
    '',
    'Code-backed status is consolidated in the registry. Product intent, architecture, domain specifications, roadmap triggers and operational evidence remain separate because they answer different questions. This report is a generated projection and never overrides those owners.',
    '',
    ...
    '- No provider readiness, cache policy, query rewrite, CQRS split, algorithm upgrade or production verification is inferred from source existence. Deferred items name the missing evidence and owner.',
    '',
    '## 4. Structure coverage',
    '',
    'The service catalog names every top-level Core API module and links module-specific specifications where they exist. [16-module-blueprint.md](../16-module-blueprint.md), [05-coding-standards.md](../05-coding-standards.md), [11-engineering-principles.md](../11-engineering-principles.md) and architecture tests remain the structure rules; this report does not duplicate them.',
    '',
    ...
    '- Operational and CI readiness: intentionally outside this feature registry; use the applicable runbook, workflow result and artifact/SHA.',
    '',
