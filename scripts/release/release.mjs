...
function build() {
  const publicBuildEnv = {
    ...
    NEXT_PUBLIC_AUTH_FACEBOOK_APP_ID: values.FACEBOOK_APP_ID,
    NEXT_PUBLIC_AUTH_FACEBOOK_API_VERSION:
      values.FACEBOOK_API_VERSION || 'v24.0',
    NEXT_PUBLIC_PHONE_OTP_ENABLED: 'true',
    NEXT_PUBLIC_SENTRY_DSN: values.NEXT_PUBLIC_SENTRY_DSN,
    NEXT_PUBLIC_SENTRY_ENVIRONMENT:
      values.NEXT_PUBLIC_SENTRY_ENVIRONMENT || 'production',
    NEXT_PUBLIC_SENTRY_RELEASE: runtimeEnv.SENTRY_RELEASE,
    ...
    VITE_SENTRY_ENVIRONMENT: values.VITE_SENTRY_ENVIRONMENT || 'production',
    VITE_SENTRY_RELEASE: runtimeEnv.SENTRY_RELEASE,
  };
